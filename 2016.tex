...
\begin{frame}
  ...
  \item \TeX을 만드는데 사용된 \texttt{WEB} 이나 C 언어
    ...
    \TeX\ 엔진까지 쉽게 건드릴 수 있다니!
  \item mplib 과 같은 새로운 기능 추가
  \end{itemize}
\end{frame}

%
\begin{frame}
  \frametitle{\luatex의 전형적인 사용례}
  \begin{itemize}
...
\begin{frame}
  ...
  \vspace{-5mm}
  \begin{align*}
    \sqrt{2}&=\ltcfrac[1;2,2,\ldots] =[1;\overline{2}] \\
    \sqrt{3}&=\ltcfrac[1;1,2,\ldots] =[1;\overline{1,2}]
  \end{align*}
  \vspace{5mm}
         {\scriptsize
...
\begin{frame}[fragile]
  ...
  \large
\begin{verbatim}
  \alphametics{INTO+ONTO+CANON+INTACT%
...
\begin{frame}[fragile]
  ...
  \large
\begin{verbatim}
  \alphametics[h]{VIOLIN+VIOLIN+VIOLA%
    =TRIO+SONATA}
\end{verbatim}
\end{frame}
